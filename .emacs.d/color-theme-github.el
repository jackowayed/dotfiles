;;http://github.com/dudleyf/color-theme-github/tree/master/color-theme-github.el
...
(defun color-theme-github ()
  ...
  (color-theme-install
   '(color-theme-github
     ((background-color . "#000000");;(background-color . "#f8f8ff")
      ...
      (mouse-color . "sienna1"))
     ()
     (default ((t (:stipple nil :background "#000000" :foreground "#FFFFFF" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal))))
